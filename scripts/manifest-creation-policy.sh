...
# Configuration
BUCKET_NAME="audit-build-permanent-message-batch"
POLICY='{
    "Version": "2012-10-17",
    "Statement": [
        {
            ...
            "Action": "s3:PutObject",
            "Resource": "arn:aws:s3:::audit-build-permanent-message-batch/*",
            "Condition": {
                "StringEquals": {
                    "aws:SourceAccount": "761029721660",
                    "s3:x-amz-acl": "bucket-owner-full-control"
                },
                "ArnLike": {
                    "aws:SourceArn": "arn:aws:s3:::audit-build-permanent-message-batch"
                }
            }
        }
    ]
